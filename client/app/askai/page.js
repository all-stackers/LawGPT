    ...
    <div className="h-screen flex flex-col">
      ...
      {chatMessages.length == 0 && (
        <div className="grid grid-cols-2 gap-4 w-[750px] pb-[90px]  mx-auto">
          <div
            className="p-[5px] px-4 rounded-[12px] border-[1px] border-gray-300 hover:bg-[#ececf1]"
            onClick={() => {
              setInputMessage(
                "What are the key elements to establish a valid contract under the Indian Contract Act, 1872?"
              );
            }}
          >
            ...
            <p className="text-[#40414f] text-[14px] opacity-[0.5] font-medium text-[12px]">
              to establish a valid contract under the Indian Contract Act, 1872?
            </p>
          </div>
          <div
            className="p-[5px] px-4 rounded-[12px] border-[1px] border-gray-300 hover:bg-[#ececf1]"
            onClick={() => {
              setInputMessage(
                "Give me a brief overview of the legal framework for trademark registration in India."
              );
            }}
          >
            <h1 className="text-[#40414f] text-[14px] font-bold">
      ...
      <div className="fixed w-[750px] bottom-[20px] left-1/2 transform -translate-x-1/3 bg-transparent flex items-center">
        ...
        >
          {askingAI ? (
            <ScaleLoader className="mt-[-4px]" color="#19c37d" />
          ) : (
            <img
              className="h-[20px]"
