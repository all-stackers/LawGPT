...
const OCR = () => {
  ...
  const uploadImageFormData = () => {
    ...
    if (image) {
      ...
      fetch("http://localhost:5000/ocr", requestOptions)
  ...
  return (
    <div className="px-8 py-4 flex flex-col">
      ...
      <div className="flex flex-row min-w-[80%] mx-auto gap-x-16 mt-16 justify-center">
        <div className="flex flex-col items-center">
          ...
          {loading ? (
            ...
            <button
              className="my-4 py-2 px-8 bg-blue-600 text-white rounded-full"
              onClick={uploadImageFormData}
            >
              Upload Image
            </button>
          )}
        ...
        {convertedText && (
          <div className="flex flex-col w-[400px] items-center">
            <div className="h-[270px] overflow-y-auto p-4 border border-gray-300 rounded">
              {convertedText}
            </div>

            <button className="my-4 w-fit align-center py-2 px-8 bg-gray-700 text-white rounded-full">
              Go to Chat
            </button>
          </div>
        )}
